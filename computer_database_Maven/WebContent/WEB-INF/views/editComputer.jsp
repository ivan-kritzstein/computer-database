				...
				<div class="col-xs-8 col-xs-offset-2 box">
					...
					<form action="editComputer" method="POST">
						...
						<fieldset>
							...
							key="lbl.edit.computerName" /></label> <input
							...
							key="lbl.edit.introducedDate" /></label> <input
							...
							key="lbl.edit.discontinuedDate" /></label> <input
							...
							key="lbl.edit.company" /></label> <select
						...
						<div class="actions pull-right">
							...
							key="lbl.edit.edit" />" class="btn btn-primary"  >
							or <a href="dashboard" class="btn btn-default"><fmt:message
							key="lbl.edit.cancel" /></a>
						</div>
					</form>
				</div>
			</div>
